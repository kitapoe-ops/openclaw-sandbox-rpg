...
| Run **full** regression suite (185 tests at L2-ship; 381 tests as of 2026-06-08) | no | yes |
...
>
> Why: OpenClaw subagents have a 15-minute hard cap on `mode="run"`. The full regression suite (185 tests at L2-ship time; 381 tests as of 2026-06-08) takes 10-30 seconds; the summary doc is ~150 lines of writing. Both can push a subagent over the cap. Hand off finalization to main agent for 100% completion rate.
...
**Update (2026-06-08):** Test suite has grown to 381 passing + 1 skipped (0 fail). Suite runs in ~10s. Subagent cap still 15 min; M2 hand-off pattern continues to apply.
