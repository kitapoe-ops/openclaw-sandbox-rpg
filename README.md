...
- **381 tests, 10s full suite** — tier 1 (logic), tier 3 (HTTP), concurrency, integration, multiplayer, state machine
...
backend/tests/  (381 tests, 10s full suite)
...
**Total: 381 tests passing (1 skipped, excluding smoke tests when Postgres is off), 0 regression**
