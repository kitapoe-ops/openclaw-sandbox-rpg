...
# Removed direct main.app import to prevent circular import during initialization
...
# memory_router inclusion is now managed by backend/main.py
...
# Import app from main at the very end to break circular dependency
